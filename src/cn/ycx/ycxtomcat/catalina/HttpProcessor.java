...
import cn.ycx.ycxtomcat.servlets.DefaultServlet;
import cn.ycx.ycxtomcat.servlets.InvokerServlet;
import cn.ycx.ycxtomcat.servlets.JspServlet;
import cn.ycx.ycxtomcat.util.Constant;
import cn.ycx.ycxtomcat.util.SessionManager;
import cn.ycx.ycxtomcat.util.WebXMLUtil;
import cn.ycx.ycxtomcat.webappservlet.HelloServlet;
...
public class HttpProcessor {
    public void execute(Socket s, Request request, Response response) throws IOException {
        try {
            ...
            prepareSession(request, response); //准备session
