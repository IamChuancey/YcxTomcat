...
public class ServerXMLUtil {
    public static List<Context> getContexts(Host host) throws WebConfigDuplicatedException {
    ...
    public static List<Host> getHosts(Engine engine) throws WebConfigDuplicatedException {
