...
public class JspUtil {
    ...
    public static void main(String[] args) {
        try {
            Context context = new Context("/webforycxtomcat", "/Users/chuancey/Idea-Workspace/webforycxtomcat/web", null,true);
            File file = new File("/Users/chuancey/Idea-Workspace/webforycxtomcat/web/index.jsp");
